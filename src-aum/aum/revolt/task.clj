(ns aum.revolt.task
  (:require
   ...
   [aum.revolt.tasks.sass :as sass]
   [aum.revolt.tasks.assets :as assets]
   [aum.revolt.tasks.aot :as aot]
   [aum.revolt.tasks.write-info :as write-info]
   [aum.revolt.tasks.copy-newrelic-jar :as copy-newrelic-jar]
   [aum.revolt.tasks.update-html :as update-html]
   [aum.revolt.tasks.capsule :as capsule]
